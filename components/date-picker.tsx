...
const DatePicker: React.FC<DatePickerProps> = ({
  ...
  return (
    <div className="grid max-w-full grid-cols-3 gap-4 dark:text-white">
      <Select onValueChange={handleDayChange}>
        <SelectTrigger className="h-auto min-h-[60px] shadow-sm focus:outline-0 focus:ring-0 focus:ring-offset-0">
          <SelectValue
            placeholder={
